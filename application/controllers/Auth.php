...
class Auth extends CI_Controller
{
	...
	public function index() {
		$this->load->view('_templates/auth/_appnew.php');
		$this->load->view('auth/index');
		$this->load->view('_templates/auth/_footers.php');
	}

	public function courses() {
		$this->load->view('_templates/auth/_appnew.php');
		$this->load->view('auth/courses');
		$this->load->view('_templates/auth/_footers.php');
	}

	public function programs() {
		$this->load->view('_templates/auth/_appnew.php');
		$this->load->view('auth/programs');
		$this->load->view('_templates/auth/_footers.php');
	}
	...
	public function login()
	{
		...
		$this->data['fitursourceconnection'] = [
			'name' => 'fitursourceconnection',
			'id' => 'fitursourceconnection',
			'type' => 'text',
...
// 		$this->form_validation->set_rules('fitursourceconnection', 'Fitur Source Connection', 'required|trim');
		...
		if ($this->form_validation->run() === TRUE)	{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember)){
				...
				$fitursourceconnection = $this->input->post('fitursourceconnection');
				$this->db->where('id', $user_id);
				$this->db->update('users', ['fitursourceconnection' => $fitursourceconnection]);
