<style type="text/css">
    Center Element Horizontal Vertical by igniel.com .center {
        display: flex;
        align-items: center;
                            ...
                            <div class="center" style="margin-left: 20px;">
                                <div class="col-lg-2 col-xs-4">
                                    <div class="alert bg-yellow">
                                        <h5>Percobaan</i></h5>
                                        <center><span class="d-block"><span>
                                                    <h5><b><?= $total ?> Kali</b></h5>
                                                </span></span></center>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-xs-4">
